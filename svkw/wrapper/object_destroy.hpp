...
template <auto Call, typename Parent> class object_destroy {
...
public:
  ...
  constexpr explicit object_destroy(ParentArg &&parent) noexcept
...
constexpr auto
deleter_selector([[maybe_unused]] deleter::object_destroy option) noexcept {
